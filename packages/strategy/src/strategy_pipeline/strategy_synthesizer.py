...
from .strategyzer_mapper import BusinessModelCanvas, StrategyzerMapper, ValuePropositionCanvas
...
class StrategyBrief(BaseModel):
    ...
    value_proposition_canvas: Optional[ValuePropositionCanvas] = None
...
class StrategySynthesizer:
    ...
    def synthesize_strategy(
        ...
        portfolio: Optional[InitiativePortfolio] = None,
    ...
    def _generate_implementation_roadmap(self, portfolio: InitiativePortfolio) -> str:
        ...
        if high_priority:
            ...
            roadmap_sections.append(f"Phase 1 (0-6 months): Critical Priorities\n" + "\n".join(phase1_items))
        ...
        if medium_priority:
            ...
            roadmap_sections.append(f"Phase 2 (6-12 months): Supporting Initiatives\n" + "\n".join(phase2_items))
        ...
        if low_priority:
            ...
            roadmap_sections.append(f"Phase 3 (12+ months): Future Opportunities\n" + "\n".join(phase3_items))
