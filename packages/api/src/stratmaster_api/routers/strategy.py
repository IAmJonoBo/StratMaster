...
# Multipart upload (python-multipart) may be unavailable in minimal test envs
try:  # pragma: no cover - optional dependency
    import python_multipart as multipart  # type: ignore  # noqa: F401
...
if _MULTIPART_AVAILABLE:
    ...
    @router.post("/parse")
    async def parse_document_unavailable() -> dict[str, str]:  # pragma: no cover - optional
        raise HTTPException(status_code=503, detail="python-multipart not installed")
